---
title: Cafeteria - Online ordering and store management for coffe shops.
---
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Power your next Coffee Shops  <br className='sm:block hidden'/>with Cafeteria.</h1>
    <p className="subtitle">Online ordering and store management for coffe shops.</p>
  ...
  <div className="features-container">
    <div className="content-container">
      <Features>
        <Feature index={0} large centered id="docs-card" href="/docs" className="h-[800px]">
        ...
        <Feature index={1} centered className="card-with-border" href="/docs">
          <div className="h-full flex flex-col">
            <h3> <span style={{ fontWeight: 300 }}>Setup your shop </span> <br/> in just a minute.</h3>
            <div>
              <p className="subtitle">
